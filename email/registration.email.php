...
<table width="100%" cellpadding="1" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td align="center" class="article-content" width="50%" style="border-radius: 2px;" bgcolor="#6D5095">
            <a target="_blank" style="font-family:'Montserrat',sans-serif;font-weight: bold;display: inline-block;color: #fff;text-decoration: none;padding: 8px 12px; border: 1px solid #6D5095;border-radius: 2px;" href="[RN24_BASE_URL]/login?email=[RN24_EMAIL]">
                Entra
            </a>
        </td>
        <td align="center" class="article-content" width="25%"></td>
